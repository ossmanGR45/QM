...
public class DbInitializer : IDbInitializer
{
    ...
    //private void SeedActions( Responsible responsible)
    //{
    ...
    //    {
    //        new Actions {ActionName="help!!!!!!", ActionDescription = "action description test", ActionType = Enums.ActionType.Avoidance,Responsible=responsible   }, // Assuming ID 1 exists
    ...
    //private Responsible SeedResponsible()
    //{
    //    if (_unitOfWork.Repository<Responsible>().FindAllAsync().GetAwaiter().GetResult().Any()) return null;

    //    // NOTE: We rely on the Categories being saved first so the IDs exist
    //    var Responsible = new List<Responsible>
    //    {
    //        new Responsible { Name = " othman " }, // Assuming ID 1 exists
            
    //    };

    //    _unitOfWork.Repository<Responsible>().AddUpdateAsync(Responsible).GetAwaiter().GetResult();
    //    return Responsible.First();
    //}
